...
public class ActionsTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        new Actions(driver).dragAndDrop(driver.findElement(By.id("draggable")),driver.findElement(By.id("droppable"))).build().perform();
        Thread.sleep(3000);

        new Actions(driver).contextClick(driver.findElement(By.id("droppableExample-tab-simple"))).build().perform();
        Thread.sleep(3000);
